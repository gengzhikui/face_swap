...
"""
FACE_POINTS = list(range(0, 78))
JAW_POINTS = list(range(0, 19))
LEFT_EYE_POINTS = list(range(19, 29))
LEFT_BROW_POINTS = list(range(29, 37))
NOSE_POINTS = list(range(37, 47))
RIGHT_EYE_POINTS = list(range(47, 57))
RIGHT_BROW_POINTS = list(range(57, 65))
MOUTH_POINTS = list(range(65, 78))

LEFT_FACE = list(range(0, 10)) + list(range(29, 34))
RIGHT_FACE = list(range(9, 19)) + list(range(57, 62))
...
def matrix_marks(res):
    pointer = [
        ...
        [res['mouth_lower_lip_bottom']['x'], res['mouth_lower_lip_top']['y']],
