...
def face_merge(dst_img, src_img, out_img,
               ...
               blur_detail_x=None, blur_detail_y=None, mat_multiple=None, correct_color_enable=0):
    src_matrix, src_points, _ = core.face_points(src_img)
    dst_matrix, dst_points, _ = core.face_points(dst_img)
